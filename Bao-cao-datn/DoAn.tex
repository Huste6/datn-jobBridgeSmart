...
% \include{lstlisting} % Đã loại bỏ do không tồn tại và tránh cảnh báo ngoài document
...
\subfile{Bia.tex} % Phần bía
\subfile{Bia_lot.tex} % Phần bía
% \restoregeometry
...
\subfile{Chuong/1_Gioi_thieu.tex} % Phần mở đầu
...
\subfile{Chuong/3_Phan_tich_thiet_ke.tex}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TRIỂN KHAI VÀ ĐÁNH GIÁ THỰC NGHIỆM HỆ THỐNG}
