...
{\textbf{\Large{JobBridge AI - Xây dựng hệ thống tuyển dụng thông minh với triển khai tự động chuẩn doanh nghiệp trên Azure Kubernetes Service}}\\[1cm]

{\textbf{\large{Nguyễn Ngọc Quân}}}\\
{\large{quan.nn225662@sis.hust.edu.vn}}\\[0.5cm]
